    ...
    Function ArduinoVB() As Integer 'This function starts the Arduino-VB communication.
        ...
        For i = 1 To 10
            If Arduino.BytesToRead > 0 Then 'Checks for activity on the Arduino.
                Clean_Line = Split(Arduino.ReadLine(), ",") 'Splits data from the arduino into separate responses.
            End If
        Next
        ...
        Do 'This code will run throughout the session to allow response collection. 
            Try
                ...
                lblTime.Text = CInt(vTimeNow / 1000) 'This and the following 6 lines update values of interest on the main form.
